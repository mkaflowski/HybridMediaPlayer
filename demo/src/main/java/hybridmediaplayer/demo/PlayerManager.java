...
/* package */ final class PlayerManager extends DefaultEventListener
    ...
    private PlayerManager(
        ...
        if (localPlayerView == null)
            localPlayerView = new PlayerView(context);

        if (castControlView == null)
            castControlView = new PlayerControlView(context);
     ...
     *
     * @param sample The {@link DemoUtil.Sample} to append.
     */
     ...
     */
    public DemoUtil.Sample getItem(int position) {
