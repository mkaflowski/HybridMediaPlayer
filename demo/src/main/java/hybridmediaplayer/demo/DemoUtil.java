...
/* package */ final class DemoUtil {
  ...
  public static final String MIME_TYPE_AUDIO_UNKNOWN = MimeTypes.AUDIO_UNKNOWN;
  public static final String MIME_TYPE_VIDEO_UNKNOWN = MimeTypes.VIDEO_UNKNOWN;
  ...
  static {
    ...
    samples.add(new Sample("https://github.com/mediaelement/mediaelement-files/blob/master/big_buck_bunny.mp4?raw=true", "Dizzy (MP4)",
            MIME_TYPE_VIDEO_MP4));
